...
SOURCE_FILE="buffered_print.cpp"
mkdir -p objdumps
OUTPUT_FILE_BASE="objdumps/buffered_print"
...
for FLAG in "${FLAGS[@]}"; do
    ...
    g++ $FLAG -std=c++20 -fverbose-asm -I$HEADER_DIR -o $OUTPUT_FILE $SOURCE_FILE
...
for FLAG in "${FLAGS[@]}"; do
    ...
    echo "[Redirecting err to /dev/null] Executing: $OUTPUT_FILE"
